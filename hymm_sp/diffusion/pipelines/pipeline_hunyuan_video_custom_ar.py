...
from ...modules import HYVideoARDiffusionTransformer as HYVideoDiffusionTransformer # 250703
...
class HunyuanVideoCustomARPipeline(DiffusionPipeline):
    r"""
    ...
    def prepare_latents(self, batch_size, num_channels_latents, num_inference_steps,height, width, frame, dtype, device, timesteps,generator, latents=None, denoise_strength=1.0, pre_frame_latents=None, scene_latents=None):
        shape = (
            batch_size,
        ...
        # 250723 input scene video latent frames
        if scene_latents is not None:
            latents = scene_latents
    ...
    def __call__(
        ...
        scene_latents: Optional[torch.Tensor] = None, # 250723
