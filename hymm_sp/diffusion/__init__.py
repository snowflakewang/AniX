...
#from .pipelines import HunyuanVideoCustomPipeline, HunyuanVideoCustomARPipeline
from .pipelines import HunyuanVideoCustomPipeline, HunyuanVideoCustomARPipeline, HunyuanVideoCustomARV2VPipeline
...
def load_ar_diffusion_pipeline(args, rank, vae, text_encoder, text_encoder_2, model, scheduler=None,
                            device=None, progress_bar_config=None):
    """ Load the denoising scheduler for inference. """
    if scheduler is None:
        scheduler = FlowMatchDiscreteScheduler(shift=args.flow_shift_eval_video, reverse=args.flow_reverse, solver=args.flow_solver, )
    ...
    pipeline = HunyuanVideoCustomARPipeline(vae=vae,
                                       text_encoder=text_encoder,
                                       text_encoder_2=text_encoder_2,
                                       transformer=model,
                                       scheduler=scheduler,
...
def load_ar_v2v_diffusion_pipeline(args, rank, vae, text_encoder, text_encoder_2, model, scheduler=None,
                            device=None, progress_bar_config=None):
    """ Load the denoising scheduler for inference. """
    if scheduler is None:
        scheduler = FlowMatchDiscreteScheduler(shift=args.flow_shift_eval_video, reverse=args.flow_reverse, solver=args.flow_solver, )
    ...
    pipeline = HunyuanVideoCustomARV2VPipeline(vae=vae,
                                       text_encoder=text_encoder,
                                       text_encoder_2=text_encoder_2,
                                       transformer=model,
                                       scheduler=scheduler,
...
#                                     video_shift=args.flow_shift_eval_video,
