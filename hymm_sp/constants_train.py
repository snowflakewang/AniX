...
__all__ = [
    "C_SCALE", "PROMPT_TEMPLATE", "MODEL_BASE", "PRECISION_TO_TYPE",
    "PRECISIONS", "VAE_PATH", "TEXT_ENCODER_PATH", "TOKENIZER_PATH",
    "NORMALIZATION_TYPE", "ACTIVATION_TYPE",
    "TEXT_PROJECTION", "DATA_TYPE", "NEGATIVE_PROMPT", 
    "FLOW_PATH_TYPE",
    "FLOW_PREDICT_TYPE",
    "FLOW_LOSS_WEIGHT",
    "FLOW_SNR_TYPE",
...
# 250724, copy from HYCustom-V2V/hymm_sp/constants.py
ANNOTATOR_PATH = {
